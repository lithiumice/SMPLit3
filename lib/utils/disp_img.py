...
if 0:
    ...
    PIL.Image.fromarray(hq_img).show()
    import PIL

    PIL.Image.fromarray(hq_faces[0]).show()

if 0:
    from show_libs.utils.disp_img import show_PIL_im_window
...
def gen_cheers_board(im_size=8, im_size2=8):
