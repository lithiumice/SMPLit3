...
def attach_smplx_pca_func(model):
    ...
    def hand_pca_to_axis(self, lhand_pca, rhand_pca):
        ...
        lhand_axis = xhand_cvt(lhand_pca, self.left_hand_mean, self.left_hand_components)
        rhand_axis = xhand_cvt(rhand_pca, self.right_hand_mean, self.right_hand_components)
    ...
    if not hasattr(model, 'hand_axis_to_pca'): setattr(model, 'hand_axis_to_pca',hand_axis_to_pca)
    if not hasattr(model, 'hand_pca_to_axis'): setattr(model, 'hand_pca_to_axis',hand_pca_to_axis)
