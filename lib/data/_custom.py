...
class CustomDataset(torch.utils.data.Dataset):
    ...
    # <===================
        ...
        misc = {'cam_intrinsics': self._to(self.intrinsics),   # other keyword arguments
             'bbox': self._to(bbox),
             'res': self._to(self.res)}
        
        if 'contact' in self.tracking_results[index].keys():
            misc['contact'] = self.tracking_results[index]['contact']
