...
cfg.LOSS.JOINT2D_LOSS_WEIGHT = 5.0
cfg.LOSS.JOINT3D_LOSS_WEIGHT = 5.0
cfg.LOSS.POSE_LOSS_WEIGHT = 1.0
...
def parse_args(test=False):
    ...
    parser.add_argument(
        "-c", "--cfg", type=str, default="./configs/debug.yaml", help="cfg file path"
    )
    parser.add_argument(
    ...
    parser.add_argument("--post_fitting", action="store_true", help="...")
    parser.add_argument(
        "--render",
        default=False,
        type=bool_arg,
