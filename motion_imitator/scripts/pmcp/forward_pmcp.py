...
if __name__ == "__main__":
    ...
    checkpoint = torch_ext.load_checkpoint(
        f"output/dgx/{exp_name}/Humanoid_{epoch:08d}.pth"
    )
    amass_train_data_take6 = joblib.load(
        "data/amass/pkls/amass_isaac_im_train_take6_upright_slim.pkl"
    )
    ...
    torch_ext.save_checkpoint(
        f"output/dgx/{exp_name}/Humanoid_{epoch + 1:08d}", checkpoint
    )
