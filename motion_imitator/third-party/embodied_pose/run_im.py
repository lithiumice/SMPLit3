...
sys.path.insert(
    0, "/root/apdcephfs/private_wallyliang/PLANT/motion_imitator/third-party"
)
...
from embodied_pose.utils.hybrik import (
    batch_inverse_kinematics_transform_naive,
    batch_inverse_kinematics_transform,
)
from embodied_pose.utils.config import (
    set_np_formatting,
    get_args,
    parse_sim_params,
    load_cfg,
...
if __name__ == "__main__":
    ...
    runner.algo_factory.register_builder(
        "pose_im_rnn", lambda **kwargs: ImitatorAgent(**kwargs)
    )  # training agent
    runner.player_factory.register_builder(
        "pose_im_rnn", lambda **kwargs: ImitatorPlayer(**kwargs)
    )  # testing agent
    ...
    runner.model_builder.network_factory.register_builder(
        "pose_im_rnn", lambda **kwargs: ImitatorBuilder()
