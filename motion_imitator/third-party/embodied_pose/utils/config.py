...
def get_args(benchmark=False):
    custom_parameters = [
        ...
        {"name": "--resume", "action": "store_true", "default": False,"help": "Resume training or start testing from a checkpoint"},
        {"name": "--resume_id", "type": str, "default": None},
        {"name": "--checkpoint", "type": str, "default": None,"help": "Path to the saved weights, only for rl_games RL library"},
        ...
        {"name": "--task", "type": str, "default": None,"help": "Can be BallBalance, Cartpole, CartpoleYUp, Ant, Humanoid, Anymal, FrankaCabinet, Quadcopter, ShadowHand, Ingenuity"},
        {"name": "--task_type", "type": str,"default": "Python", "help": "Choose Python or C++"},
        {"name": "--rl_device", "type": str, "default": "cuda:0","help": "Choose CPU or GPU device for inferencing policy network"},
        ...
        {"name": "--num_envs", "type": int, "default": 0,"help": "Number of environments to create - override config file"},
        ...
        {"name": "--horizon_length", "type": int, "default": -1,"help": "Set number of simulation steps per 1 PPO iteration. Supported only by rl_games. If not -1 overrides the config settings."},
