...
env_params = dict(episode_length=300, motion_file="assets/motions_binary/gym/squat.pkl")

training_params = dict(max_epochs=10000, save_interval=2000, terminate_reward=-1)
