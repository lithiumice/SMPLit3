import sys; sys.path.append('/home/lithiumice/PHC/third-party/vid2player')
...
parser.add_argument('-e', '--exp', action='store', dest='exp_list',type=str, nargs='*', default=['federer'],help="Examples: -e v8.3.1.0")
