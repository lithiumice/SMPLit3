...
class Video3DPoseDataset(Dataset):
    ...
    def __init__(
        ...
        self.joint_pos_arr = np.load(os.path.join(opt.dataset_dir, 'joint_pos.npy'), mmap_mode='r')
        self.joint_rot_arr = np.load(os.path.join(opt.dataset_dir, 'joint_rot.npy'), mmap_mode='r')
