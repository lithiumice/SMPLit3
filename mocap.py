...
def init_model_org():
    args = dict(
        ...
        use_acr=True,
        debug=True,
        save_split_vid=False,
        save_normal_map=False,
        ...
        use_opt_pose_reg=False,
        skip_save_vis_if_exists=False,
        save_opt_tmp=False,
        opt_lr=1.0,
        runing_fps=-1,
        save_wham_npz=False,
    ...
    return (cfg, args, network, detector)
...
def mocap_org(
    ...
    (cfg, args, network, detector) = models
