...
def mano_param_processing(
    mano_params: Dict, has_mano_params: Dict, rot: float, do_flip: bool
) -> Tuple[Dict, Dict]:
    """
...
def get_example(
    ...
    mano_params, has_mano_params = mano_param_processing(
        mano_params, has_mano_params, rot, do_flip
    )
