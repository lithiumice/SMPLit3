...
class Renderer(nn.Module):
    def __init__(
        self, render_full_head=False, obj_filename=f"{_DATA}/head_template.obj"
    ):
        super(Renderer, self).__init__()
        self.image_size = 224

        # import ipdb;ipdb.set_trace()
        obj_filename = f"{_DATA}/head_template_mesh.obj"
        ...
        flame_masks = pickle.load(
            open(f"{_DATA}/FLAME_masks/FLAME_masks.pkl", "rb"), encoding="latin1"
        )
