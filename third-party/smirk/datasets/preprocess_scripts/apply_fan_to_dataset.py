...
parser = argparse.ArgumentParser(
    description="Process images/videos with https://github.com/hhj1897/face_alignment."
)
...
face_detector = RetinaFacePredictor(
    threshold=0.8, device="cuda:0", model=RetinaFacePredictor.get_model("mobilenet0.25")
)
