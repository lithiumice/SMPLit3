    ...
    def visualize_renderer_verts_list(
        ...
        if images is not None:
            ...
            rendered_imgs = (
                ...
                + images * valid_mask * (1 - visible_weight)
                + (1 - valid_mask) * images
            )
        ...
        **kwargs
        ...
        for vis_name in show_items:
            ...
            if vis_name == "mesh" and outputs["detection_flag"]:
                ...
                rendered_imgs = self.visualize_renderer_verts_list(
                    per_img_verts_list,
                    per_img_j3d_list,
                ...
                if "put_org" in vis_cfg["settings"]:
                    ...
                    for inds, j in enumerate(used_org_inds):
                        ...
                        org_imge[ct : ih - cb, cl : iw - cr] = resized_images[
                            pt : ph - pb, pl : pw - pr
                        ]
