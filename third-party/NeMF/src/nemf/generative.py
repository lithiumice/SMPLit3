...
MEAN_PATH=os.path.join(os.path.dirname(__file__),'../../../../model_files/nemf_body/mean-male-128-30fps.pt')
STD_PATH=os.path.join(os.path.dirname(__file__),'../../../../model_files/nemf_body/std-male-128-30fps.pt')
...
class Architecture(BaseModel):
    ...
    def load(self, epoch=None, optimal=False):
        self.args.save_dir = os.path.join(os.path.dirname(__file__),'../../../../model_files/nemf_body/generative')
