...
current_path = "/apdcephfs/share_1330077/wallyliang/ReInterhand"
...
def download(capture_id):
    ...
    for name in name_list[capture_id]:
        cmd = (
            "wget https://fb-baas-f32eacb9-8abb-11eb-b2b8-4857dd089e15.s3.amazonaws.com/ReInterHand/"
            + capture_id
            + "/mano_fits/mano_fits.tar.gz"
            + name
        )
        os.system(cmd)
