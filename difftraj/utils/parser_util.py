...
def add_base_options(parser):
    ...
    group.add_argument("--train_data_path", type=str, action='append')
    group.add_argument("--load_mean_path", type=str, default='')
...
def add_diffusion_options(parser):
    ...
    group.add_argument("--train_cmdm_base", action='store_true')
    group.add_argument("--eval_joints_metrics", action='store_true', help="")
    group.add_argument("--in_type", default="", type=str,)
    group.add_argument("--seq_len", default=128, type=int, help=".")
    group.add_argument("--use_ar", action='store_true')
    group.add_argument("--p_len", default=15, type=int, help=".")
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', type=str, help="Dataset name (choose from list).")
    ...
    group.add_argument("--add_mask", action='store_true', help="")
    group.add_argument("--diffpose_body_only", action='store_true', help="")
...
def add_training_options(parser):
    ...
    group.add_argument("--use_gan", action='store_true', help="use_gan.")
    group.add_argument("--use_siddms_gan", action='store_true', help="use_siddms_gan.")
    group.add_argument("--lr_d", default=1e-4, type=float, help=".")
    group.add_argument("--base_model", default="", type=str,)
...
def add_sampling_options(parser):
    ...
    group.add_argument("--vis_save_dir", type=str, default='')
    group.add_argument("--user_transl", action='store_true', help="")
    group.add_argument("--eval_cmdm_base", action='store_true', help="")
    group.add_argument("--eval_cmdm_finetune", action='store_true', help="")
    group.add_argument("--infer_step", default=2, type=int, help=".")
    group.add_argument("--difine_traj", default='rec', choices=['line','rec','circle','spline'], type=str)
    group.add_argument("--traj_rev_dir", default=0, type=int, help=".")
    group.add_argument("--traj_face_type", default=0, type=int, help=".")
    group.add_argument("--gen_time_length", default=10, type=int, help=".")
    group.add_argument("--infer_walk_speed", default=1.0, type=float, help="m/s")
    group.add_argument("--replication_times", default=20, type=int, help=".")
