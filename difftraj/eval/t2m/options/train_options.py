...
class TrainDecompOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--dataset_name', type=str, default='style100', help='Dataset Name')
        ...
        self.parser.add_argument('--use_vae', action="store_true", help='')
        self.parser.add_argument('--use_triplet_loss', action="store_true", help='')
        self.parser.add_argument('--pred_style', action="store_true", help='')
        self.parser.add_argument('--in_type', type=str, default='debug', help='')
        self.parser.add_argument('--split_radio', type=float, default=0.8, help='')
        self.parser.add_argument('--ex_fps', type=int, default=20, help='')
        self.parser.add_argument('--dim_pose', type=int, default=203, help='')
        self.parser.add_argument('--ae_type', type=str, default='ae3', help='')
        self.parser.add_argument('--no_inp_norm', action="store_true", help='')
        self.parser.add_argument('--log_interval', type=int, default=3, help='')
