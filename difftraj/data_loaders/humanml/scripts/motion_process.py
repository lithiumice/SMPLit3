...
# joints_num = 22
# # ds_num = 8
# data_dir = '/root/apdcephfs/private_wallyliang/PLANT/Thirdparty/humanml_github/joints'
# save_dir1 = '/root/apdcephfs/private_wallyliang/PLANT/Thirdparty/humanml_github/HumanML3D/new_joints'
# save_dir2 = '/root/apdcephfs/private_wallyliang/PLANT/Thirdparty/humanml_github/HumanML3D/new_joint_vecs'
...
from data_loaders.humanml.utils.paramUtil import t2m_raw_offsets
n_raw_offsets = torch.from_numpy(t2m_raw_offsets)
kinematic_chain = t2m_kinematic_chain

# Get offsets of target skeleton
# example_data = np.load(os.path.join(data_dir, example_id + '.npy'))
example_data = np.load(os.path.join(os.path.dirname(__file__),'../../../../model_files/012314.npy'))
example_data = example_data.reshape(len(example_data), -1, 3)
example_data = torch.from_numpy(example_data)
tgt_skel = Skeleton(n_raw_offsets, kinematic_chain, 'cpu')
# (joints_num, 3)
